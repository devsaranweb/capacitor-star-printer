...
export interface StarPrinterPlugin {
   ...
   *                           `'usb'` is Android-only
   */
  discover(options?: { timeoutMs?: number; interfaces?: StarPrinterInterface[] }): Promise<void>;
   ...
   */
  connect(options: { identifier: string; interface?: StarPrinterInterface }): Promise<void>;
